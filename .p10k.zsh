# Generated by Powerlevel10k configuration wizard on 2019-12-25 at 20:01 MST.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND='005'
  ...
  # Format for the current time: Sep 23 09:51. See `man 3 strftime`.
  typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%h %d %H:%M}'
